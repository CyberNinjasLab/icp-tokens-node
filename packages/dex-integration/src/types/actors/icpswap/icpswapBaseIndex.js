export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'batchUpdateTokenPrice7dVolumeUSD' : IDL.Func(
    ...
    'getTokenPriceMetadata' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Text, TokenPrice))],
        ['query'],
      ),
    'getTransferPositionStorageCount' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Nat)), IDL.Int],
        ['query'],
      ),
